      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Driving Growth: Unleashing Success with the Latest Tools at Elyteweb`,
              description: `At Elyteweb, we propel business growth using the latest tools and technologies. From advanced analytics to cutting-edge marketing platforms, we ensure your success through innovation. Stay ahead with us and embrace tools that streamline operations and drive sustainable growth.`,
            }}
          />
